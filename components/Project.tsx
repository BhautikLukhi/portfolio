...
const Project = ({title, description, tags, imageUrl}: ProjectProps ) => {
  ...
  >
    <motion.section 
    className=' bg-gray-100 max-w-[42rem] border brder-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] rounded-lg hover:bg-gray-200 transition sm:group-even:pl-8 dark:bg-white/10 dark:hover:bg-white/20'
  >
